...
namespace PizzeriaS7.Migrations
{
    ...
    [Migration("20240731072541_PopulateIngredienti")]
    partial class PopulateIngredienti
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DettaglioOrdine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzeriaS7.Models.Ordine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DettaglioOrdine", b =>
                {
                    b.HasOne("PizzeriaS7.Models.Ordine", "Ordine")
                        .WithMany("DettagliOrdine")
                        .HasForeignKey("OrdineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzeriaS7.Models.Prodotto", "Prodotto")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PizzeriaS7.Models.Utente", null)
                        .WithMany()
